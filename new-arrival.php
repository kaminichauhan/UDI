<div id="shopify-section-template--14826244636727__product_listing_n7patd" class="shopify-section">
  <section data-ga-view-custom data-ga-view-info-custom="index"
    ...
    <div class="">
      <section>
        <div class="flex-col">
          ...
          <div
            class="text-title-template--14826244636727__product_listing_n7patd mb-[1rem] lg:mb-[1.25rem] lg:items-center"> NEW ARRIVALS</div>
    ...
    <div class="product-listing-btn flex justify-center mb-5  pr-4 lg:pr-0  mt-[16px] lg:mt-6 w-full">
      <a class="flex items-center w-full lg:w-1/4" href="collections/latest-drop-by-veirdo.html">
        <div
          class="flex justify-center cursor-pointer h-12 shop-all-button_wrapper-template--14826244636727__product_listing_n7patd action-button-wrapper w-full ">
          <button
            class=" font-[soraSemiBold] flex justify-center text-center items-center shop-all-button-template--14826244636727__product_listing_n7patd ">
